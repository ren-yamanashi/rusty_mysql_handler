...
// post_ddl / post_recover; capability-gated for rotate_encryption_master_key
// (ENCRYPTION) and redo_log_set_state (ENGINE_LOG). push_to_engine,
// get_cost_constants, and the three statistics callbacks are bound here for
// completeness but their handlerton pointers stay NULL — the opaque
// pass-through cannot synthesise the engine-owned outputs (SE_cost_constants,
// ha_statistics, ha_tablespace_statistics) those callbacks need.
extern "C" {
